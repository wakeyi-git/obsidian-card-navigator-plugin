  ...
  renderCards(cardsData, cardWidth, cardHeight) {
    ...
    cardsData.forEach((cardData) => {
      ...
      if (this.plugin.settings.fixedCardHeight) {
        ...
        card.style.maxHeight = `${cardHeight * 2}px`;
      }
