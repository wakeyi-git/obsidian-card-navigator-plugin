import { ICard, ICardSection } from '../../models/Card';
...
export interface ICardService {
   ...
   * @returns 생성된 카드
   */
  createCardFromFile(file: TFile, section: ICardSection): Promise<ICard>;
   ...
   * @returns 업데이트된 카드
   */
  updateCard(card: ICard, section: ICardSection): Promise<ICard>;
