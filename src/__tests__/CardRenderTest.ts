...
describe('카드 렌더링 테스트', () => {
  ...
  it('카드 렌더링 테스트', () => {
    ...
    expect(cardElement.querySelector('.card-header')).toBeDefined();
    expect(cardElement.querySelector('.card-body')).toBeDefined();
    expect(cardElement.querySelector('.card-footer')).toBeDefined();
  });
