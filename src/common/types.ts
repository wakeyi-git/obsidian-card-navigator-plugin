...
export const rangeSettingConfigs: Record<NumberSettingKey, RangeSettingConfig> = {
	autoSavePresetInterval: { min: 10, max: 100, step: 10 },
	maxPresetCount: { min: 1, max: 20, step: 1 },
