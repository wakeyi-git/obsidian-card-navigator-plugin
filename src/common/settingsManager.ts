// settingsManager.ts
import { TFolder, Notice, debounce } from 'obsidian';
...
export class SettingsManager {
    ...
    // Cleanup method to be called when the plugin is unloaded
    public cleanup() {
        this.saveSettingsDebounced.cancel(); // Cancel any pending save operations
    }
}
